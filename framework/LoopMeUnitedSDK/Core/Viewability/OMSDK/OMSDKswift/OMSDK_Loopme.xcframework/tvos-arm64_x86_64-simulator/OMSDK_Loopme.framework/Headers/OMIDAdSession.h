 ...
 */
@property(nonatomic, readonly) OMIDLoopmeAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDLoopmeAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDLoopmeAdSessionContext *)context
