...
{
    private const string MaxSdkKey = "mS4u2IXJUmLuQxVgAfXAOAlRr_EkaXTz88uiE5HHG5RJ3OlVC81NmdXhl5H3bINKhAe3oufK2FD9rXC6xpIJd9";

#if UNITY_IOS
    private const string InterstitialAdUnitId = "1fc903a950c51d3e";
    private const string RewardedAdUnitId = "dfd4fcbe11acafdf";
    private const string RewardedInterstitialAdUnitId = "f7f6a13f97e9ac28";
    private const string BannerAdUnitId = "1ef882e49e5d9430";
    private const string MRecAdUnitId = "3e1f21cb9982a2c4";
#else // UNITY_ANDROID
