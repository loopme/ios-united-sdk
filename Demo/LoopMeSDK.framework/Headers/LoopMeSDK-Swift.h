...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LoopMeSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP9LoopMeSDK32LoopMeServerCommunicatorDelegate_")
...
SWIFT_CLASS("_TtC9LoopMeSDK14VastProperties")
...
@interface VastProperties (SWIFT_EXTENSION(LoopMeSDK)) <NSXMLParserDelegate>
