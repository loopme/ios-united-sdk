#
#  Be sure to run `pod spec lint LoopMeSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.com/loopme/ios-united-sdk.git", :tag => "7.2.7" }
  ...
  # s.source_files  = "LoopMeSDK/**/*.{h,m}"
  # s.exclude_files = "Classes/Exclude"

  # s.public_header_files = "LoopMeSDK/*.h", "LoopMeSDK/Internal/Utility/LoopMeLogging.h"
  ...
  # s.frameworks = "StoreKit", "CoreLocation", "SystemConfiguration", "CoreTelephony", "CoreGraphics", "CoreMedia", "AudioToolbox", "CoreAudio", "AVFoundation", "AdSupport"
  s.vendored_frameworks = "LoopMeUnitedSDK.embeddedframework/LoopMeUnitedSDK.framework"
